...
package com.tanzania.jkisanga.pazasauti.utils;
...
public class FormatterUtil {
    ...
    public static CharSequence getRelativeTimeSpanString(Context context, String dateTime) {
        long time = 0;
        String string_date = dateTime;
    ...
    public static CharSequence getRelativeTimeSpanStringShort(Context context, String dateTime) {
